...
const (
	...
	IncidentDetectionChartDir = "manifests/charts/mcoa/charts/incident-detection"
...
//go:embed manifests/charts/mcoa/charts/incident-detection/templates/_helpers.tpl
var FS embed.FS
